# Tasks: Define turnturn v1 Roadmap
...
- [ ] Add scripted test provider for deterministic loop tests.
- [ ] Add tool registry and sequential executor.
- [ ] Add policy gate contract and approval event types.
